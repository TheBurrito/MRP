...
void initSensor() {
  ...
  sProf = new SonarProfile(7.0, 3.0, 0.5, dtor(30), 0.2);
  sReg = new SonarIterativeRegion(dtor(2), 0.066, dtor(30), 0.2);
...
int main(int argc, char** argv) {
  ...
  std::string ptfile, mapfile, host;
  int port;
